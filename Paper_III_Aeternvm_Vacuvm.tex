...
\end{itemize}
The evolution history is shown in Fig.~\ref{fig:hmc}.

\begin{figure}[h]
\centering
\includegraphics[width=0.9\columnwidth]{../figures/fig3_HMC_evolution.jpg}
\caption{Evolution of total action, vacuum density $\langle\phi\rangle$ and $V_{ud}^{\rm eff}$ during 200 Metropolis sweeps on a $16^4$ lattice.}
\label{fig:hmc}
\end{figure}
